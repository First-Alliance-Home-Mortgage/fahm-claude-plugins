/**
 * PROVENANCE: byte-identical copy of knowledge-docs/scripts/_shared.mjs, apart
 * from this header. Kept as a copy rather than a cross-skill import so either
 * skill can be installed alone; kept identical so `diff` against the original
 * stays meaningful. Do not edit here - fix it there and re-copy.
 *
